...
@jjit
def precompute_ssp_obsmags(
    ssp_wave, ssp_fluxes, filter_waves, filter_trans, z_obs, Om0, w0, wa, h
):
    """Precompute observed magnitudes of a collection of SEDs on a redshift grid
    ...
    z_obs : float
        Redshift at which the magnitudes will be computed
    ...
    """
    ssp_obsmag_table = _calc_obs_mag_vmap_f_ssp(
        ssp_wave, ssp_fluxes, filter_waves, filter_trans, z_obs, Om0, w0, wa, h
    )
    return ssp_obsmag_table
